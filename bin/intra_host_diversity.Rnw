...
order_chrom = c("PV062510_PB2", "PV074323_PB1", "PV062508_PA", "PV062513_HA",
                "PV062507_MP", "PV062511_NA", "PV062509_NP", "PV062512_NS")

# Clean data
complete_data <- data %>%
  select(-IsSynonymous, -AltAminoAcid, -AltCodon) %>% # Recompute these based on minor and major variant
  subset(VariantType == "SNP") %>%
  mutate(
    Percentage = as.numeric(Percentage),
    CHROM=factor(CHROM, levels=order_chrom)
